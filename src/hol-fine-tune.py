...
# usage : python3 run.py --description="batch size 2" 
...
parser.add_argument('--pack-to', type=str, required=False, default='/home/zpp/')
...
shutil.make_archive(args.pack_to + description, 'zip', current_folder)
print("--- Zipped")
